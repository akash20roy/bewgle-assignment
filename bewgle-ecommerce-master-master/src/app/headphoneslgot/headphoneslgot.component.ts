...
@Component({
  selector: 'app-headphoneslgot',
  templateUrl: './headphoneslgot.component.html',
  styleUrls: ['./headphoneslgot.component.css']
})
export class HeadphoneslgotComponent implements OnInit {
  [x: string]: any;
  title="pro1";
